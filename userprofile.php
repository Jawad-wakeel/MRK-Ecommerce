...
<body class="biolife-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="shpcart-subtotal-block">
                            ...
                            <div class="subtotal-line ">
                                <p class="stt-name" style="font-weight: normal;">Use Coupon (MRK)</p>
                                <br>
                                <input type="text" name="coupon" id="cupon" class="form-control" style="width:40%; padding:5px; display:inline" placeholder="Use Coupon">
                                <span class="stt-price" style="font-weight: normal;" id="discount"><?php echo '$' . 0 ?></span>
                            </div>
                            <hr style="border-top:1px solid #313030">
                            <div class="subtotal-line">
                                <b class="stt-name" style="font-weight: normal;">Total</b>
                                <span class="stt-price" style="font-weight: normal;" id="afterdiscount"><?php echo '$'; ?></span>
                            </div>
                            <div style="margin-top: 25px;">
                                <b class="stt-name">Payment <span class="sub"></span></b>
                                <input type="text" style="border: none; width:100%;" placeholder="Input Card Number" name="txid" required>
                            </div>
                            <div style="margin-top: 25px;">
    ...
    function totalOfAll() {
        ...
        for (let i = 0; i < item_total.length; i++) {
            total += parseFloat(item_total[i].innerText.replace('$', ''));
        }
        totalAll.innerText = '$' + total.toFixed(2);
    }

    $(document).ready(function () {
        var cupon_code = $("#cupon");
        var discount = $("#discount");
        var total_price = parseFloat($("#totalOfall").text().replace('$', ''));
        $("#afterdiscount").text('$' + total_price.toFixed(2));
        ...
        function updateAfterDiscount() {
            var afterDiscount = total_price - parseFloat(discount.text().replace('$', ''));
            $("#afterdiscount").text('$' + (isNaN(afterDiscount) ? '0.00' : afterDiscount.toFixed(2)));
        }
