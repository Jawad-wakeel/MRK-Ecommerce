...
<div class="advance-product-box">
                                ...
                                <div class="biolife-banner style-01 biolife-banner__style-01 sm-margin-top-30px xs-margin-top-80px border">
                                    <div class="banner-contain">
                                        <a href="#" class="bn-link"></a>
                                        <div class="text-content">
                                            <span class="first-line">All time</span>
                                            <b class="second-line">Quality</b>
                                            <i class="third-line">Products</i>
